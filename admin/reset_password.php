...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['admin_email']) && !isset($_POST['new_password'])) {
    ...
    } elseif (isset($_POST['admin_email']) && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
...
<body class="bg-gray-50">
    ...
    <div class="mobile-nav fixed top-0 right-0 w-64 h-full bg-gray-900 z-50 shadow-2xl p-6 safe-area-top safe-area-bottom">
        ...
        <nav class="space-y-6">
            ...
            <a href="register_admin.php" class="block text-white text-lg py-3 hover:text-green-400 transition-colors border-b border-gray-700">
        ...
        <div class="container mx-auto px-4 py-4 md:py-8 safe-area-top">
            ...
            <nav class="flex justify-between items-center py-4 md:py-6">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="index.php" class="text-white hover:text-green-400 transition-colors duration-300 font-medium">Login</a>
                    <a href="register_admin.php" class="bg-gradient-to-r from-green-400 to-blue-500 text-white px-6 py-2 rounded-full hover:from-green-500 hover:to-blue-600 transition-all duration-300 font-medium pulse-animation">
                        Get Started
                    </a>
                </div>
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-120px)] py-8 md:py-12">
                ...
                <div class="lg:w-1/2 lg:pl-12 fade-in-up">
                    <div class="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-lg max-w-lg mx-auto slide-form">
                        ...
                        <form method="POST" action="" class="space-y-6">
                            <!-- Hidden email field -->
                            <input type="hidden" name="admin_email" value="<?php echo htmlspecialchars($resetEmail); ?>">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-16 w-full md:w-2/3">
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="admin.php" class="text-gray-400 hover:text-white transition-colors text-sm md:text-base">Login</a></li>
                            <li><a href="register_admin.php" class="text-gray-400 hover:text-white transition-colors text-sm md:text-base">Register</a></li>
