...
<body class="bg-gray-50">
    ...
    <div class="mobile-nav fixed top-0 right-0 w-64 h-full bg-gray-900 z-50 shadow-2xl p-6 safe-area-top safe-area-bottom">
        ...
        <nav class="space-y-6">
            ...
            <a href="login_admin.php" class="block text-white text-lg py-3 hover:text-green-400 transition-colors border-b border-gray-700">
        ...
        <div class="absolute bottom-6 left-6 right-6">
            <div class="text-gray-400 text-sm">
                ...
                <a href="tel:+15551234567" class="text-blue-400">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-120px)] py-8 md:py-12">
                ...
                <div class="lg:w-1/2 mb-12 lg:mb-0 stagger-animation px-2 md:px-0">
                    ...
                    <p class="text-gray-200 text-base sm:text-lg md:text-xl mb-6 md:mb-8 leading-relaxed">
                        Access the administrative dashboard to manage waste issues, monitor system activities, and oversee community contributions.
                    </p>
                        ...
                        <div class="glass-card rounded-2xl p-4">
                            <div class="grid grid-cols-3 gap-2 mb-4">
                                <div class="text-center">
                                    <div class="text-blue-400 font-bold text-lg">Admin</div>
                                    <div class="text-gray-300 text-xs">Privileges</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-purple-400 font-bold text-lg">Full</div>
                                    <div class="text-gray-300 text-xs">Access</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-green-400 font-bold text-lg">Secure</div>
                                    <div class="text-gray-300 text-xs">Portal</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:w-1/2 lg:pl-12 fade-in-up">
                    <div class="glass-card rounded-2xl p-6 md:p-8 backdrop-blur-lg max-w-lg mx-auto">
                        ...
                        <div class="mb-6 text-center">
                            <span class="bg-gradient-to-r from-purple-500 to-blue-500 text-white py-2 px-6 rounded-full text-sm font-semibold">
                                <i class="fas fa-user-shield mr-2"></i> ADMINISTRATOR ACCESS
                            </span>
                        </div>
                        ...
                        <form method="POST" action="" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="email" 
                                       ...
                                       name="email" 
                                       required 
                                       class="w-full bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl py-4 px-5 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200 input-focus"
                            ...
                            <div>
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <a href="reset_password.php" class="text-blue-400 hover:text-blue-300 text-sm">
                                        Forgot password?
                                    </a>
                                </div>
                                <div class="relative">
                                    <input type="password" 
                                           ...
                                           name="password" 
                                           required 
                                           class="w-full bg-white/10 border border-white/20 text-white placeholder-gray-400 rounded-xl py-4 px-5 pr-12 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200 input-focus"
                                           placeholder="••••••••">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       id="remember" 
                                       class="w-5 h-5 rounded border-white/30 bg-white/10 text-blue-400 focus:ring-blue-400 focus:ring-offset-0">
                            ...
                            <!-- Login Button -->
                            <button type="submit" 
                                    class="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-4 px-6 rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 hover-lift pulse-animation shadow-lg">
                            ...
                            <div class="relative my-6">
                                ...
                                <div class="relative flex justify-center text-sm">
                                    <span class="px-4 bg-transparent text-gray-400">Access Levels</span>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-6">
                                <p class="text-gray-400">
                                    ...
                                    <a href="register_admin.php" 
                                       class="text-blue-400 hover:text-blue-300 font-semibold ml-2">
                                        Register here
                                    </a>
                                </p>
                            </div>
                    ...
                    <div class="hidden sm:block mt-8">
                        <div class="glass-card rounded-2xl p-6 backdrop-blur-lg">
                            <div class="grid grid-cols-3 gap-4 text-center">
                                <div>
                                    <div class="text-2xl md:text-3xl font-bold text-blue-400">Admin</div>
                                    <div class="text-gray-300 text-sm">Privileges</div>
                                </div>
                                <div>
                                    <div class="text-2xl md:text-3xl font-bold text-purple-400">Full</div>
                                    <div class="text-gray-300 text-sm">Access</div>
                                </div>
                                <div>
                                    <div class="text-2xl md:text-3xl font-bold text-green-400">Secure</div>
                                    <div class="text-gray-300 text-sm">Portal</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-16 w-full md:w-2/3">
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="login_admin.php" class="text-gray-400 hover:text-white transition-colors text-sm md:text-base">Admin Login</a></li>
                            ...
                            <li><a href="register_admin.php" class="text-gray-400 hover:text-white transition-colors text-sm md:text-base">Register Admin</a></li>
                        </ul>
                    </div>
                    <div>
    ...
    <div class="fixed bottom-6 right-6 md:hidden z-40">
        <a href="register_admin.php" class="w-14 h-14 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110 pulse-animation">
